...
class NavTest():  
    def __init__(self):  
        ...
        #locations['2'] = Pose(Point(1.000, 0.500, 0.000), Quaternion(0.000, 0.000, 1.000, 3.140))  
        #locations['3'] = Pose(Point(-1.000, 0.500, 0.000), Quaternion(0.000, 0.000, 1.000, -1.570))  
        #locations['4'] = Pose(Point(-1.000, 1.000, 0.000), Quaternion(0.000, 0.000, 1.000, -1.570))  
        #locations['5'] = Pose(Point(1.000, 1.000, 0.000), Quaternion(0.000, 0.000, 1.000, 0.000))  
        #locations['6'] = Pose(Point(0.000, 0.000, 0.000), Quaternion(0.000, 0.000, 1.000, 0.000))  
